INSERT INTO movie_app.movie_dtls (movieName,director,price,movieCategory,status,photo,email,genre,`year`,video,quantity,movie_category,movie_name,photo_name,photoName) VALUES
	 ...
	 ('Cast Away','Robert Zemeckis','25','Old','Active','castaway.jpg','admin@gmail.com','Drama','2000',NULL,1,NULL,NULL,NULL,NULL),
	 ('Terminator 2: Judgment Day','James Cameron','28','Old','Active','terminator2.jpg','admin@gmail.com','Fantasy','1986',NULL,1,NULL,NULL,NULL,NULL),
